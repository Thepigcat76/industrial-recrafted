package com.portingdeadmods.indrec.impl.recipes.components.energy;
...
public record EnergyOutputComponent(int energy) implements RecipeComponent {
    ...
    public static final Type<EnergyOutputComponent> TYPE = new Type<>(IndustrialRecrafted.rl("energy_output"), CODEC, STREAM_CODEC);

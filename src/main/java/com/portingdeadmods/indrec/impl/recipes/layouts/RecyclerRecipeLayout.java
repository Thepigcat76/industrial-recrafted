...
import com.portingdeadmods.indrec.impl.recipes.components.items.DynamicItemInputComponent;
...
public class RecyclerRecipeLayout extends MachineRecipeLayout<MachineRecipeImpl> {

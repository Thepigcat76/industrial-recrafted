...
public final class IRItems {
    ...
    public static final DeferredItem<DynamiteItem> DYNAMITE = ITEMS.registerItem("dynamite", DynamiteItem::new);
    /* Electric Tools */
    ...
    public static final DeferredItem<ScrapItem> SCRAP = ITEMS.registerItem("scrap", ScrapItem::new);
